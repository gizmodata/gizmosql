...
| Component                                                                        | Version  |
|----------------------------------------------------------------------------------|----------|
| [DuckDB](https://duckdb.org)                                                     | v1.3.2   |
...
- 🔌 [SQLAlchemy dialect](https://github.com/gizmodata/sqlalchemy-gizmosql-adbc-dialect) - can be used for connecting to GizmoSQL with [Apache Superset](https://superset.apache.org)
